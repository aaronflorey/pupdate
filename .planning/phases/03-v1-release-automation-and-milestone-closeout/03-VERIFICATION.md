...
| REL-02 | verified | `03-01-SUMMARY.md`; `.github/workflows/ci.yml` and `.github/workflows/release.yaml` wire CI and release orchestration on the documented trigger scopes |
| REL-03 | verified | `03-01-SUMMARY.md`; `.github/workflows/release.yaml` runs GoReleaser after Release Please creates a release, checking out `needs.release-please.outputs.tag_name` and using `.goreleaser.yaml` |
